...
('Анна Смирнова', 'Парикмахер-стилист', 7, 'Создаю стрижки и окрашивания, которые подчеркивают индивидуальность.', 'master-anna-smirnova.png', 1, JSON_OBJECT('mon','09:00-21:00','tue','09:00-21:00','wed','09:00-21:00','thu','09:00-21:00','fri','09:00-21:00','sat','10:00-20:00','sun','10:00-20:00')),
...
SELECT 'Диана Орлова', 'Парикмахер-колорист', 6, 'Сложные окрашивания, блонд, восстановление волос и подбор формы стрижки.', 'master5-new.jpg', 1, JSON_OBJECT('mon','09:00-21:00','tue','09:00-21:00','wed','09:00-21:00','thu','09:00-21:00','fri','09:00-21:00','sat','10:00-20:00','sun','10:00-20:00')
WHERE NOT EXISTS (SELECT 1 FROM masters WHERE name = 'Диана Орлова');

INSERT INTO masters (name, specialization, experience_years, bio, photo, is_active, working_hours)
SELECT 'Виктория Соколова', 'Парикмахер-стилист', 8, 'Женские и мужские стрижки, укладки, окрашивания и уходовые процедуры.', 'master6-new.webp', 1, JSON_OBJECT('mon','10:00-20:00','tue','10:00-20:00','wed','10:00-20:00','thu','10:00-20:00','fri','10:00-20:00','sat','10:00-20:00','sun','10:00-20:00')
WHERE NOT EXISTS (SELECT 1 FROM masters WHERE name = 'Виктория Соколова');

INSERT INTO masters (name, specialization, experience_years, bio, photo, is_active, working_hours)
SELECT 'Алина Белова', 'Мастер маникюра', 4, 'Маникюр, гель-лак, укрепление, дизайн и аккуратная обработка кутикулы.', 'master7-new.webp', 1, JSON_OBJECT('mon','09:00-21:00','tue','09:00-21:00','wed','09:00-21:00','thu','09:00-21:00','fri','09:00-21:00','sat','10:00-20:00','sun','10:00-20:00')
WHERE NOT EXISTS (SELECT 1 FROM masters WHERE name = 'Алина Белова');

INSERT INTO masters (name, specialization, experience_years, bio, photo, is_active, working_hours)
SELECT 'Юлия Морозова', 'Мастер маникюра и педикюра', 7, 'Маникюр, педикюр, нюдовые покрытия, укрепление и быстрый салонный дизайн.', 'master8-new.webp', 1, JSON_OBJECT('mon','10:00-20:00','tue','10:00-20:00','wed','10:00-20:00','thu','10:00-20:00','fri','10:00-20:00','sat','10:00-20:00','sun','10:00-20:00')
WHERE NOT EXISTS (SELECT 1 FROM masters WHERE name = 'Юлия Морозова');

INSERT INTO masters (name, specialization, experience_years, bio, photo, is_active, working_hours)
SELECT 'Полина Волкова', 'Лэшмейкер', 5, 'Классика, 2D/3D, натуральные эффекты и комфортная носка ресниц.', 'master9-new.webp', 1, JSON_OBJECT('mon','10:00-20:00','tue','10:00-20:00','wed','10:00-20:00','thu','10:00-20:00','fri','10:00-20:00','sat','10:00-20:00','sun','10:00-20:00')
WHERE NOT EXISTS (SELECT 1 FROM masters WHERE name = 'Полина Волкова');

INSERT INTO masters (name, specialization, experience_years, bio, photo, is_active, working_hours)
SELECT 'Наталья Ким', 'Мастер по ресницам и бровям', 6, 'Ламинирование ресниц, наращивание, оформление и окрашивание бровей.', 'master10-new.webp', 1, JSON_OBJECT('mon','09:00-21:00','tue','09:00-21:00','wed','09:00-21:00','thu','09:00-21:00','fri','09:00-21:00','sat','10:00-20:00','sun','10:00-20:00')
WHERE NOT EXISTS (SELECT 1 FROM masters WHERE name = 'Наталья Ким');

INSERT INTO masters (name, specialization, experience_years, bio, photo, is_active, working_hours)
SELECT 'София Романова', 'Визажист-бровист', 5, 'Макияж, оформление бровей, ламинирование и подбор образа под событие.', 'master11-new.webp', 1, JSON_OBJECT('mon','10:00-20:00','tue','10:00-20:00','wed','10:00-20:00','thu','10:00-20:00','fri','10:00-20:00','sat','10:00-20:00','sun','10:00-20:00')
...
-- Обновление фотографий в существующей базе
UPDATE masters SET photo='master5-new.jpg' WHERE name='Диана Орлова';
UPDATE masters SET photo='master6-new.webp' WHERE name='Виктория Соколова';
UPDATE masters SET photo='master7-new.webp' WHERE name='Алина Белова';
UPDATE masters SET photo='master8-new.webp' WHERE name='Юлия Морозова';
UPDATE masters SET photo='master9-new.webp' WHERE name='Полина Волкова';
UPDATE masters SET photo='master10-new.webp' WHERE name='Наталья Ким';
UPDATE masters SET photo='master11-new.webp' WHERE name='София Романова';
